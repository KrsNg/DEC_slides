...
\centering
\subfloat[\tiny{$\rho$} \label{fig:rhoU}]
{\includegraphics[width=0.65\textheight, trim=0cm 0cm 0cm 0cm,clip=true]{./figs/rho.png}}
\subfloat[\tiny{$\Psi_{\rho}$} \label{fig:adjRhoU}]
{\includegraphics[width=0.65\textheight, trim=0cm 0cm 0 0cm,clip=true]{./figs/rhoAdjoint.png}}
\end{figure}
\vspace{-10pt}
\begin{itemize}
\scriptsize
